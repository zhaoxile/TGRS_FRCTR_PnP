function [varargout]=hysime_snlrsf(varargin);
%
...
if nargout == 2, varargout(2) = {E};end %Instead of outputing Ek matrix which columns are the eigenvectors that span 
%           the signal subspace, we ouput the whole basis E when applying
%           it for FastHyDe and FastHyIn.
return
